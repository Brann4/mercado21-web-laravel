    ...
    <div class="container-lg">
        <div class="box-check-c text-center">
            ...
            <div class="mt-3">
                ...
                <div class="mt-4">
                    <a href="" class="btn btn-custom btn-custom-sm">Ir al panel de pedidos</a>
                </div>
            </div>
            <!-- m -->
        </div>
...
@endif
@if($order->payment_method_id == 3 && $order->payment_status == 0)
<section class="contact-area pb-100">
    <div class="container-lg">
        <div class="box-check-c text-center">
            <div>
            ...
            <div class="mt-3">
                ...
                <div class="text-c-c-1 font-700">Monto Pagado <br/>S/ {{ $order->total }}</div>
                <div class="text-code-order py-3">Tu Número del Pedido es <br/><span>{{ $order->order_id }}</span></div>
                <div class="mt-4">
                    <a href="" class="btn btn-custom btn-custom-sm">Ir al panel de pedidos</a>
                </div>
    ...
    <div class="container-lg">
        <div class="box-check-c text-center">
            ...
            <div class="mt-3">
                ...
                <div class="text-code-order py-3">Tu Número del Pedido es <br/><span>{{ $order->order_id }}</span></div>
                <div class="mt-4">
                    <input type="hidden" id="order_endpoint" value="" />
                    <input type="hidden" id="order_code" value="" />
